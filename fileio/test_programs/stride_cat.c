...
int main(int argc, char* argv[]) {
    ...
    struct io300_file* inf = io300_open(argv[3], MODE_READ, "\e[0;31min\e[0m");
    ...
    struct io300_file* outf = io300_open(argv[4], MODE_WRITE, "\e[0;32mout\e[0m");
